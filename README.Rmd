...
[![CRAN status](https://www.r-pkg.org/badges/version/oldr)](https://CRAN.R-project.org/package=oldr){.pkgdown-release}
[![cran checks](https://badges.cranchecks.info/worst/bbw.svg)](https://cran.r-project.org/web/checks/check_results_bbw.html)
...
[![Codecov test coverage](https://codecov.io/gh/rapidsurveys/oldr/graph/badge.svg)](https://app.codecov.io/gh/rapidsurveys/oldr)
...
::: {.pkgdown-devel}
You can install the latest development version of `{oldr}` from [GitHub](https://github.com/rapidsurveys/oldr) with:
...
You can also install `{oldr}` through the [RapidSurveys R Universe](https://rapidsurveys.r-universe.dev) with:
