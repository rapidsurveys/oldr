...
- Submit an issue on the [issues
  page](https://github.com/rapidsurveys/oldr/issues)
...
- Make sure to track progress upstream i.e., on our version of `oldr` at
  `rapidsurveys/oldr`, by doing
...
- Please write a test or tests for your changes if they affect code and
